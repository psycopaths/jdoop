...
class JDoop:
    ...
    def sort_by_num_of_sym_vars(self, unit_tests):
        """Walks over unit tests generated by Randoop, turns them into driver
        programs for JDart, and returns their list sorted in a
        decreasing order by the number of symbolic variables. Drivers
        with no symbolic variables are not included as they correspond
        to expensive concrete execution replays within JDart"""
    ...
    def jdart_suites_to_junit4(self, darted_suites):
