...
class RandoopRun:
    ...
    def run(self):
        ...
        os.mkdir(self.unit_tests_directory)
...
class JPFDoop:
    ...
    def compile_tests(self, unit_tests):
        ...
        try:
            os.mkdir(self.paths.tests_compilation_dir)
        except:
            pass
    ...
    def generate_jpf_conf(self, unit_tests, root_dir):
        ...
        jpf_configuration_files = CoordinateConfFileGeneration(unit_tests.randooped_package_name, root_dir, 'classes-to-analyze', self.paths.tests_compilation_dir)
